...
const Post = ({ post }) => {
  ...
  const likeHandler = () => { 
    try {
      const res= axios.put(`/posts/${post._id}/like`, {userId:userinfo._id})
    ...
    <div className={styles.post}>
      <div className={styles.postWrapper}>
        <div className={styles.postTop}>
          ...
          <img src={user.profilePicture||PUBLIC_FOLDER+"noimage.png"} alt="" className={styles.postImg} />
          </Link>
        ...
        <div className={styles.postBottom}>
          <div className={styles.postBottomStats}>
            <div className={styles.likes}>
              <img className={styles.postLike} src={EXTERNAL_FOLDER+"assets/likes.png"} alt="" />
