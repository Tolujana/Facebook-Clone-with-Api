    ...
    <div className={styles.share}>
      <form className={styles.shareWrapper} encType="multipart/form-data">
        <div className={styles.shareTop}>
          <img src={!user.profilePicture? PF+"noimage.png":user.profilePicture}alt="" className={styles.sharepics} />
          <input
          ref={userInput}
        ...
        <div className={styles.shareBottom}>
          <div className={styles.shareOptions}>
            ...
            <div className={styles.shareOption}>
              ...
              />
              <label htmlFor="file" className={styles.ShareOptionText}>Photo/Video</label>
              <input  style={{display:"none"}}type="file" id="file" className="" accept=".png,.jpeg,.jpg,.mp4" onChange={handlefile}/>
            ...
            <div className={`${styles.shareOption} ${styles.green}`}>
                            <span onClick={submitHandler} className={styles.ShareOptionText}>Share</span>
            </div>
          </div>
        </div>
      </form>
